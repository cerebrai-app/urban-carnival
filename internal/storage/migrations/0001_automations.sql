...
-- them like any other.
--
-- This file may still be edited freely because no tagged release has run it
-- yet. Once it ships, treat it as immutable and make further seed changes in
-- a new NNNN_*.sql migration instead.
